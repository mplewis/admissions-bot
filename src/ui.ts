...
import { ActionRowBuilder, TextInputBuilder, TextInputStyle, APIEmbed } from 'discord.js';
import { FIELD } from './constants';
import { getLastUserSubmittedEvent } from './cache';
import { EventData } from './events';

const getFieldValue = (embed: APIEmbed | undefined, fieldId: keyof typeof FIELD) =>
	...
	return [
		...
		new ActionRowBuilder<TextInputBuilder>().addComponents(
			new TextInputBuilder()
				...
				.setRequired(true)
				.setPlaceholder("Come to my birthday party! I'm allergic to cake so please bring muffins.")
